...
public class AnimationController {
    ...
    public static void scaleFadeIn(View view, long durationMillis, long delayMillis) {
        ScaleAnimation animation_scale = new ScaleAnimation(0.96f, 1, 0.96f, 1, rela1, 0.1f, rela1, 0f);
        AlphaAnimation animation_fade = new AlphaAnimation(0.8f, 1);
        AnimationSet animation = new AnimationSet(false);
        animation.addAnimation(animation_scale);
        animation.addAnimation(animation_fade);
        animation.setFillAfter(true);
        baseIn(view, animation, durationMillis, delayMillis);
    }

    public static void scaleFade(View view, long durationMillis) {
        ScaleAnimation animation_scale = new ScaleAnimation(0.96f, 1, 0.96f, 1, rela1, 0.1f, rela1, 0f);
        AlphaAnimation animation_fade = new AlphaAnimation(0.2f, 1);
        AnimationSet animation = new AnimationSet(false);
        animation.addAnimation(animation_scale);
        animation.addAnimation(animation_fade);
        animation.setDuration(durationMillis);
    ...
    public static void viticalIn(View view, long durationMillis, long delayMillis) {
        TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela1, -1f, rela1, 0);
        animation.setFillAfter(true);
        animation.setInterpolator(new OvershootInterpolator());
        baseIn(view, animation, durationMillis, delayMillis);
    }
    ...
    public static void viticalOut(View view, long durationMillis, long delayMillis) {
        TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela1, 0, rela1, -1f);
        animation.setFillAfter(false);
        baseOut(view, animation, durationMillis, delayMillis);
    }

    public static void viticalInDown(View view, long durationMillis, long delayMillis) {
        TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela1, 1f, rela1, 0);
        animation.setFillAfter(true);
        animation.setInterpolator(new OvershootInterpolator());
        baseIn(view, animation, durationMillis, delayMillis);
    ...
    public static void viticalOutDown(View view, long durationMillis, long delayMillis) {
        TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela1, 0, rela1, 1f);
        animation.setFillAfter(false);
        baseOut(view, animation, durationMillis, delayMillis);
    }
    ...
    public static void rotateIn(View view, long durationMillis, long delayMillis, float degrees, float yValue) {
        RotateAnimation animation = new RotateAnimation(degrees, 0, rela1, 0.5f, rela1, yValue);
        baseIn(view, animation, durationMillis, delayMillis);
    }
